...
GLuint _textureId11;//back image
GLuint _textureId12;//right image
GLuint _textureId13;//left image
GLuint _textureId14;//down image //ocean
GLuint _textureId15;//TELEPORTER
GLuint _textureId16;//MOVING LEFT RIGHT TILE
GLuint _textureId17;//TRAMPOLINE
GLuint _textureId18;//STATIC BLOCK
GLuint _textureId19;//FALLING
...
void drawCube3(float i, float j,float r,float g,float b,int type)//TRAMPOLINE
{
	...
	if(type==1)
	{
		if(in_level==1)
			...
			glBindTexture(GL_TEXTURE_2D, _textureId18);		
	}	
...
r=1;g=1;b=1;	
	...
	glBindTexture(GL_TEXTURE_2D, _textureId19);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
...
void init()
{
	...
	Image* image11 = loadBMP("l1vtr.bmp");
	_textureId11 = loadTexture(image11);
	delete image11;
	Image* image12 = loadBMP("l1images.bmp");
	_textureId12 = loadTexture(image12);
	delete image12;
	Image* image13 = loadBMP("l1images.bmp");
	_textureId13 = loadTexture(image13);
	delete image13;
	Image* image14 = loadBMP("l1ocean.bmp");
	_textureId14 = loadTexture(image14);
	delete image14;
	Image* image15 = loadBMP("l1teleporter.bmp");
	_textureId15 = loadTexture(image15);
	delete image15;
	Image* image16 = loadBMP("l1periodic.bmp");
	_textureId16 = loadTexture(image16);
	delete image16;
	Image* image17 = loadBMP("l1trampoline.bmp");
	_textureId17 = loadTexture(image17);
	delete image17;
	Image* image18 = loadBMP("l1block.bmp");
	_textureId18 = loadTexture(image18);
	delete image18;
	Image* image19 = loadBMP("periodic.bmp");
	_textureId19 = loadTexture(image19);
	delete image19;
	t3dInit();
}
